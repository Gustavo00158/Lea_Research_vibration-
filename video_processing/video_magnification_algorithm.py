...
from video_processing.visualization_functions import (
    plot_components_or_sources, plot_mode_shapes_and_modal_coordinates)
...
class Video_Magnification:
    ...
    def create_video_from_frames(self, name, frames=None, fps=None):
        ...
        out = cv2.VideoWriter('video_samples/%s.mp4' % name, fourcc, fps, size, 0)
